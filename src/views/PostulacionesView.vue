  ...
  <div>
    ...
    <v-container-fluid class="mt-15" fluid>
      ...
      <v-card style="padding-top:15px ;">
        <v-img src="https://admision.usm.cl/banner-inicio.jpg" height="300" max-width="auto">
          <v-card-title class="white--text text-h4" style="margin-top: 200px; margin-left:190px;">Bienvenido a las
            Postulaciones</v-card-title>
        </v-img>
    ...
    <div class="layout">
      <v-container fluid class="px-2 mt-1">
        ...
        <table-postulacion></table-postulacion>
      </v-container>
    </div>
    <Footer />
...
import TablePostulacion from '@/components/TablePostulacion.vue';
import Footer from '@/components/Footer.vue'
export default {
  name: 'App',
  components: { NavbarConLogin, TablePostulacion, Footer },
