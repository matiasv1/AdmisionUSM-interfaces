<template>
  ...
  <div class="pa-0">
    ...
    <v-container-fluid class="mt-15" fluid>
      ...
      <v-card style="padding-top:15px ;">
        <v-img src="https://admision.usm.cl/banner-inicio.jpg" height="300" max-width="auto" class="grey darken-4">
          <v-card-title class="white--text text-h4" style="margin-top: 200px; margin-left:190px;">Bienvenid@s a la UTFSM
          </v-card-title>
        </v-img>
    ...
    <v-container class="">
      <v-row class="mt-7">
        <v-col class="col-8">
          <h1 class="display-1 font-weight-black" >Admisión USM</h1>
        </v-col>
        <v-col class="col-4">
          <h1 class="display-1 font-weight-black" >Conoce nuestra oferta</h1>
        </v-col>
      </v-row>
      <v-row>
        <v-col class="col-8 pr-5">
          <login :flag="false"></login>
          ...
          <v-simple-table class="elevation-2 rounded">
            <tbody>
              ...
              <tr>
                <td>
                  <a href="https://usm.cl/admision/carreras/" style="text-decoration:none">
                    <h4 class="blue--text text--darken-4"> Carreras Pregrado Vespertino</h4>
                  </a>
                </td>
              </tr>
              <tr>
      ...
      <v-row class="mt-7">
        <v-col class="col-8">
          <h1 class="display-1 font-weight-black">Tour virtual 360°</h1>
        </v-col>
      </v-row>
      <v-row>
        <v-col class="col-10">
      ...
      <v-row class="mt-7">
        <v-col class="col-8 ">
          <h1 class="display-1 font-weight-black">Descubre tu futuro USM</h1>
        </v-col>
      </v-row>
      <v-row>
        <v-col class="col-10">
                ...
                <div :class="`elevation-${hover ? 24 : 6}`" class="mx-auto pa-0 transition-swing">
                  <v-card  href="https://admision.usm.cl/landpro/">
                    <v-img max-height="240px" src="https://admision.usm.cl/novedadesusm.png" gradient="to top right, rgba(0,0,0,0.6), rgba(0,0,0,0)" class="rounded-2">
                      <v-card-title class=" font-weight-bold white--text ml-13 " style="margin-top: 150px; margin-left:50px;"> Inscríbete aquí para recibir más información, novedades y actividades de admisión usm
                      </v-card-title>
      ...
      <v-row class="mt-7">
        <v-col class="col-8 ">
          <h1 class="display-1 font-weight-black">Programa IDP Crea</h1>
        </v-col>
      </v-row>
      <v-row>
        <v-col class="col-10">
                ...
                <div :class="`elevation-${hover ? 24 : 6}`" class="mx-auto pa-0 transition-swing">
                  <v-card  href="https://admision.usm.cl/landpro/">
                    <v-img max-height="240px" src="https://admision.usm.cl/programa_idp_crea.png" gradient="to top right, rgba(0,0,0,0.6), rgba(0,0,0,0)" class="rounded-2">
                      <v-card-title class=" white--text ml-13 " style="margin-top: 150px; margin-left:50px;"> Postula aquí al programa de ingeniería y creatividad aplicada
                      </v-card-title>
...
export default {
  name: 'App',
  components: { NavbarSinLogin, Login, Footer },
