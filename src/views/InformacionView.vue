    ...
    <v-container-fluid class="mt-15" fluid>
      ...
      <v-card style="padding-top:15px ;">
        <v-img src="https://admision.usm.cl/banner-inicio.jpg" height="300" max-width="auto" class="grey darken-4">
          <v-card-title class="white--text text-h4" style="margin-top: 200px; margin-left:190px;">Bienvenido a las
            Informaciones</v-card-title>
        </v-img>
      </v-card>
      ...
      <div class="layout">
        ...
        <v-container fluid class="px-2 mt-1">
          ...
          <v-row>
            <v-col v-for="card in cards" :key="card.title" :cols="card.flex" class="px-4 py-4 ">
              <v-card text :to="{ path: '/actividades/2' }" class="Opacity txt">
                <v-img :src="card.src" class="white--text align-end"
                  gradient="to bottom, rgba(0,0,0,.1), rgba(0,0,0,.5)" height="370px" max-width="450px">
                  <v-card-title v-text="card.title" class="justify-center "></v-card-title>
                  <v-card-text v-text="card.text" class="txt"></v-card-text>
                </v-img>
...
export default {
  ...
  props: ['tipo'],
  components: {
    NavbarSinLogin, NavbarConLogin, Footer

  },
  data: () => ({
    cards: [
      { title: 'ACTIVIDADES', src: 'https://admision.usm.cl/postula.jpg', flex: 3, text: 'Dentro de esta sección encontrarás informacion acerca de las actividades que se realizan dentro de la Universidad' },
      { title: 'En proceso', src: 'https://beneficiosgtm.files.wordpress.com/2022/03/image-1.png', flex: 3 },
      { title: 'En proceso', src: 'https://beneficiosgtm.files.wordpress.com/2022/03/image-1.png', flex: 3 },
      { title: 'En proceso', src: 'https://beneficiosgtm.files.wordpress.com/2022/03/image-1.png', flex: 3 },
      { title: 'En proceso', src: 'https://beneficiosgtm.files.wordpress.com/2022/03/image-1.png', flex: 3 },
      { title: 'En proceso', src: 'https://beneficiosgtm.files.wordpress.com/2022/03/image-1.png', flex: 3 },
